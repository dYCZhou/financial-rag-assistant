...
- 阶段 0：设计确认完成
- 阶段 1：数据验收与自动登记工具已完成；比亚迪 2024、2025 年报已登记
- 阶段 2：页面级解析与抽查工具已完成；比亚迪 2024、2025 年报已通过人工确认
- 阶段 3：两份年报均已完成固定长度与章节＋段落感知切分
- 阶段 4：ChromaDB双索引、BGE、中文BM25、加权RRF混合召回和通用重排
  已跑通；2024、2025 年索引可共存并通过年度过滤验证，2025冻结题
  Recall@5=93.33%
- 阶段 5：DeepSeek证据问答已接入；比亚迪2025冻结15题人工复核15/15，
  比亚迪2024评估集待建立
- 阶段 6—7：尚未实现
...
因此当前结论是“比亚迪2025单文档链路通过本轮人工验收”，但还不能据此
宣称跨公司、跨年度生成质量已经通过。改进包括财务概念组件、期间和统计
